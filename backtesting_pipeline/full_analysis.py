...
def find_matching_files(directory, ticker, interval):
    # Patrón regex para ticker e intervalo (sin importar fechas)
...
if __name__ == '__main__':
    ...
    filter_performance.to_csv(os.path.join(out_path,'filter_performance.csv'), index=False)

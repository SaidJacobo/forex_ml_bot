...
def walk_forward(
    ...
    # Ajustar el número total de barras para que sea divisible por validation_bars
    extra_bars = len(data_full) % validation_bars
    if extra_bars > 0:
        # Recortar las primeras filas para que el número de barras sea divisible
        data_full = data_full.iloc[extra_bars:]

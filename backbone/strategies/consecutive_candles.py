...
class ConsecutiveCandlesV23():
    ...
    def _calculate_units_size(self, balance, total_orders, price):
        ...
        units = self.start_lot * (loss_orders - self.trades_to_increment_risk) * self.multiplier
...
class ConsecutiveCandlesV24():
    ...
    def _calculate_units_size(self, balance, total_orders, price):
        ...
        # Ajustar el porcentaje de riesgo basado en las posiciones abiertas
        lot_base = round(balance / 100) * 100
        units = lot_base * (loss_orders - self.trades_to_increment_risk) * self.multiplier
        units = lot_base

...
class ABCMetaBot(ABC):
  """Clase base abstracta para un bot de trading y aprendizaje automático.
  ...
  def __init__(self, tickers:list, ml_agent:MachineLearningAgent, trading_agent:TradingAgent):
    """Inicializa un nuevo objeto ABCMetaBot.
  ...
  def _get_symbols_from_provider(self, date_from:str, date_to:str, ticker):
